...
{
    //quando um seedingservice for criado tambem ira receber uma dependecia do saleswebMvcContext tambem 
    public class SeedingService
    {
        //definir dependencia com o dbContext==SalesWebMvcContext.cs
        ...
        //chamar o seed dentro da class stratup dentro do metodo configure
        public void Seed()
        {
            //ANY ira testar se existi algum registro nessa tabela -> Department e caso tenha não fara nada e para o --processo--?--
            ...
            //adicionar no banco    || o metodo addRange permite que adicone varios objetos de uma só vez
            ...
            //para validar essas instruções é chamado SaveChanges, que vai salvar e confirmar as auterações feitas no banco
